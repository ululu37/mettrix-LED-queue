...
## 🖧 คำแนะนำการตั้งค่าเครือข่ายสำหรับอุปกรณ์ (Device Network Config)

ในการตั้งค่าเพื่อให้เซิร์ฟเวอร์และอุปกรณ์เรียนรู้ IP และสื่อสารกันได้ในระบบเครือข่าย แนะนำให้ใช้วิธีการดังนี้:

![ภาพตัวอย่างการตั้งค่า Device ให้รับ DHCP](./image/setupConfigDevice.png)

1. **Fix IP ที่ Notebook/Computer ก่อน**: ตั้งค่าแบบ Static IP (Fix IP) เตรียมไว้ที่เครื่องโน้ตบุ๊ก (หรือเครื่องที่คุณจะรันโปรแกรมระบบขึ้นมา) 
2. **ใช้ Router หรือ Mikrotik แจก IP**: ใช้อุปกรณ์จัดการเครือข่ายอย่าง Router หรือวงแลน Mikrotik ต่อเชื่อมเข้าหากันระหว่างเครื่องโน้ตบุ๊ก กับ ตัวอุปกรณ์ (Device/Raspberry Pi)
3. **อุปกรณ์รับ DHCP**: ปล่อยให้ระบบ Router ทำหน้าที่แจก IP อัตโนมัติ (DHCP) ไปหาตัวอุปกรณ์ เพื่อให้อุปกรณ์นำไปใช้งานและเชื่อมต่อกลับมาหาโน้ตบุ๊กของเราที่ Fix IP เอาไว้แล้วได้อย่างถูกต้องและไม่มีปัญหา IP ชนกัน
